...
def generate_launch_description():
      ...
      launch_ros.event_handlers.OnStateTransition(
          ...
          entities=[
              launch.actions.LogInfo(
                  msg="node 'microstrain_node' reached the 'unconfigured' state, 'inactivating'."
              ),
              config_event,
          ],
      )
  ...
  inactive_state_handler = launch.actions.RegisterEventHandler(
      launch_ros.event_handlers.OnStateTransition(
          ...
          entities=[
              launch.actions.LogInfo(
                  msg="node 'microstrain_node' reached the 'inactive' state, 'activating'."
              ),
              activate_event,
          ],
      )
  ...
  active_state_handler = launch.actions.RegisterEventHandler(
      launch_ros.event_handlers.OnStateTransition(
          ...
          entities=[
              launch.actions.LogInfo(
                  msg="node 'microstrain_node' reached the 'active' state."
              ),
          ],
      )
  )
  launch_description.append(inactive_state_handler)
  launch_description.append(active_state_handler)
  launch_description.append(unconfigured_state_handler)
